...
export const Hero = () => {
    return (
        <div className="flex flex-col items-center text-center gap-6 w-fu   ll">
            ...
            <div className="flex">
                <a href={'#setup'} className="py-1 px-3 h-11 rounded-md duration-200 flex items-center box-border border border-transparent hover:border-ruby-600 bg-ruby-500 hover:bg-transparent hover:text-ruby-600 font-semibold outline-none">Get Started Now</a>
            </div>
        </div>
    )
}