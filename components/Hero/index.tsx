export const Hero = () => {
    return (
        <div className="flex flex-col items-center text-center gap-6">
            ...
            <p className="px-4 text-d-base font-normal max-w-3xl">A plug & play feedback widget to gather feedback from your users. Better development. Focused iterations. Great user satisfaction. Let Saiso handle the rest.</p>
            <div>
