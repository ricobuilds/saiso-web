  ...
  return (
    <div className={'bg-russian-600 '}>
      ...
      <div className=" fixed -left-[5%] top-[9%] sm:top-[25%] w-64 h-64 blur-[3px] opacity-20">
            ...
            <div className=" fixed -right-[5%] top-[52%] w-72 h-72 blur-[3px] opacity-40 rotate-[66deg]">
      ...
      <div className="bg-russian-600 h-[100vh] w-full wrapper">
        <Header />
