...
const Home: NextPage = () => {
  return (
    <div className={'bg-darkBg'}>
      ...
      <div className=" fixed -left-[5%] top-[9%] sm:top-[25%] w-64 h-64 blur-[3px] opacity-20">
      ...
      <div className=" fixed -right-[5%] top-[60%] sm:top-[52%] w-72 h-72 blur-[3px] opacity-40 rotate-[66deg]">
      ...
      <div id='promo' className="main pt-12 text-russian-600">
        <span className='text-d-h2 gradientBg--two text-center bg-clip-text text-transparent'>How modern solopreneurs and small teams create product-led solution</span>
      </div>
